...
\input{figs_revision/fig_regime_map}
...
$3.02$. This is the condition under which quantum-kernel IDS results are most
...
adversarial feature manipulation is the norm rather than the exception.
...
qubits, under the natural prior but not under enrichment, on NSL-KDD but not on
UNSW-NB15 for the sample-size effect. A method whose advantage is confined to a
