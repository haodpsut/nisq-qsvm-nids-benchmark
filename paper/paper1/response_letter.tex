...
footing as positive ones: $21$ / $21$ / $68$ over $110$ comparisons.
\changed
...
an RBF kernel at any size we tested. Third, it is a property of the natural
prior: repeating the sweep with rare attacks enriched twelvefold to $10\%$,
the sampling our own submitted protocol used, leaves $26$ of $30$ comparisons
inconclusive with no crossover in range.

That third point is the reason the submitted version reported the opposite
conclusion, and we regard identifying it as the most useful thing this revision
does.
\changed
Sec.~V-D, Fig.~6, Table~III.
...
of phase terms. Across the same widths the dispersion correlates with
macro-$F_1$ at $r=+0.77$ for the ZZ kernel and $r=+0.32$ for the Z kernel.
\changed
...
$\alpha_{\mathrm{ZZ}}/\alpha_{\mathrm{Z}}=2.02$, the ratio predicted by
counting $\binom{n}{2}$ pairwise phase terms against $n$ single-qubit ones,
and it predicts end-task macro-$F_1$ across widths at $r=+0.77$. It tells us
